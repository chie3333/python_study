    ...
    def record_print(self):
        ...
        if row == None :    
            ...
            while True:
                ...
                print("%2s\t%10s\t%3d" % (data1, data2, data3))
                row = self.cur.fetchone()
            ...
            if self.choice == "1" :
                while True :
                    ...
                    if choice_1 == "1" :
                        ...
                        game1play.game1outcome(player1, player2)

                        database.game1record(player1.player, player1.game_count)
                        database.game1record(player2.player, player2.game_count)
                        ...
                        game2play.game2(player1.player, player2.player)
